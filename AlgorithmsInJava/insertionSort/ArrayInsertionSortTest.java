...
import AlgorithmsInJava.dataStructures.*;
public class ArrayInsertionSortTest
{
    ...
    {
        ArrayInsertionSortTest.test0();
        ArrayInsertionSortTest.test1();
        ArrayInsertionSortTest.test2();
        ArrayInsertionSortTest.test3();
        ArrayInsertionSortTest.test4();
        ArrayInsertionSortTest.test5();
    }
}